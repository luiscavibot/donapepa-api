...
const borradorSchema = new Schema(
  {
    usuario: String,
    operacion: String,
...
borradorSchema.method("toJSON", function () {
  const { __v, _id, ...object } = this.toObject();
  object.id = _id;
  return object;
});

borradorSchema.plugin(mongoosePaginate);

export default model("Borrador", borradorSchema);